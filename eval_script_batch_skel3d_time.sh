...
--finetune_from /models/000005.ckpt
  ...
  output="hdf5_skel3d_time_${checkpoint}"
  ...
  singularity exec --nv -B /project/c_mvcondif/venvs/:/venvs/ \
      ...
      -B /project/c_mvcondif/outputs/:/outputs/ \
        ...
        python batch_test.py \
          ...
          --config configs/objaverse_hdf5_skel_time.yaml \
  ...
  singularity exec --nv -B /project/c_mvcondif/venvs/:/venvs/ \
      ...
      -B /project/c_mvcondif/outputs/:/outputs/ \
        /project/c_mvcondif/containers/free3d.sif \
        python evaluations/evaluation.py --gt_path /outputs/$output/inputs/ --g_path /outputs/$output/samples_cfg_scale_3.00/ --report_path skel3d_time.csv
done
