...
def run_demo():
    ...
    config['data']['params']['num_workers'] = 16
    data = instantiate_from_config(config.data)
    # set the evaluation dataset
    # only the objaverse dataset is used for training-rendering/rendering/objaverse_skel
    # all images in gso and omniobject is used for evaluation
    if  config['data']['params']['dataname'] in ['objaverse_hdf5', 'objaverse_hdf5_time', 'objaverse_hdf5_coord', 'objaverse_skel', 'objaverse_skel_time', 'objaverse_skel_graph']:
