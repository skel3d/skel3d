...
class DiffusionWrapper(pl.LightningModule):
    ...
    def forward(self, x, t, c_concat: list = None, c_crossattn: list = None, c_adm=None, c_pose = None, c_skel = None):
        if self.conditioning_key is None:
            ...
            if hasattr(self, "scripted_diffusion_model"):
                ...
                out = self.diffusion_model(x, t, context=cc, pose=c_pose, skel=c_skel)
        elif self.conditioning_key == 'hybrid':
            xc = torch.cat([x] + c_concat, dim=1)
            cc = torch.cat(c_crossattn, 1)
            out = self.diffusion_model(xc, t, context=cc, pose=c_pose, skel=c_skel)
