...
parser.add_argument('--report_path', type=str, default='', help='path to report file')
...
if __name__ == '__main__':
    ...
    for i in range(size):
        ...
        if os.path.exists(args.g_path+gt_paths[i].split('/')[-1]):
            ...
            results.append(dict(id=gt_paths[i].split('/')[-1], l1loss=l1loss, ssim=ssim_score, psnr=psnr_score, lpips=lpips_score))
    ...
    if args.report_path:
        with open(args.report_path, 'w') as f:
            f.write('id,l1loss,ssim,psnr,lpips\n')
            for result in results:
                f.write('{},{},{},{},{}\n'.format(result['id'], result['l1loss'], result['ssim'], result['psnr'], result['lpips']))