...
def run_demo():
    ...
    parser.add_argument('--config', type=str, default='configs/objaverse_skel.yaml')
    ...
    config['data']['params']['batch_size'] = 8 #32
    config['data']['params']['num_workers'] = 8 #32
    ...
    if  config['data']['params']['dataname'] == 'objaverse_skel':
    ...
    for data in test_data:
        ...
        if 'images' in opt.gen_type:
            ...
            print('data size', data['images'].size())
